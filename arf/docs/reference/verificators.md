...
| [`verify_step_liveness.py`](../../scripts/verificators/verify_step_liveness.py) | ST | `in_progress` step heartbeats and expected-completion estimates across all tasks, plus live-VM idle-billing risk and watchdog coverage |
